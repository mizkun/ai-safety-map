...
続いて[Anthropicの経済シナリオの点検](docs/reviews/2026-09-10-economic-scenarios.md)で、人の仕事が変わりながら続く分岐を追加しました。現在は74項目・40矢印・44一次資料です。将来のモデル計算と観測を区別し、日本語・英語・ツアーへ反映しています。

3つの調査レポートを比較し、重要な主張を一次資料で確認して改訂しています。[照合と編集判断の記録](docs/research-review-2026-09-09.md)

## 使い方

1. ホームは「要点」の全体像から始まります。PCは分岐図、スマホは現在から分かれる7経路を表示します。経路を選ぶと「7経路中1経路を表示」と示し、「全体に戻す」で解除できます。「全要素」で全項目も開けます。研究の加速・自己改善は独立したシナリオではなく、制御喪失・仕事の自動化の中で開ける任意の要因です。
...
5. 「ツアー」は現在から7経路と関連する研究の加速・自己改善を順番に案内します。説明に合わせてマップが移動し、関連項目が光ります。途中で経路を選び直したり、項目を拡大して根拠を読んだりできます。
