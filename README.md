...
1. ホームの樹形図から、関心のある分岐を開きます。
2. 経路のステップを選び、説明と現在の証拠を読みます。
3. 接続部分の矢印ボタンで、次へ進むための追加条件を確認します。
4. 「さらに分解する」から、細かい条件へ進めます。深さは内容によって異なります。
...
シナリオを選ぶと、一つのステップに焦点を当てて読めます。前後のステップや細かい条件に移動でき、点線の専門用語や用語ボタンをタップすると説明が開きます。解説を閉じると元の場所に戻れます。
